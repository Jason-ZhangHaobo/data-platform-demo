...
| 经典功能广度 | 接入、离线/实时、开发、调度、资产、质量、安全、报表、DAPI/XAPI、运维均有真实合成用例；SERVER_MYSQL可在服务端白名单下探测连接、采集字段/行数摘要 | L2 | 真实MySQL/JDBC数据面、对象存储、Kafka/Flink、CDC、Python、BI连接器及规模/兼容矩阵 |
