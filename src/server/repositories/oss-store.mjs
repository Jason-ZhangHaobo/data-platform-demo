...
export { createOssRequest, ossConfigFromEnvironment } from "../../v2/oss-client.mjs";
import { createOssRequest, ossConfigFromEnvironment } from "../../v2/oss-client.mjs";
...
export class OssTaskStore extends MemoryTaskStore {
  ...
  async listQualityRules() { await this.refresh(); return super.listQualityRules(); }
  async getQualityRule(id) { await this.refresh(); return super.getQualityRule(id); }
  async createQualityRule(input) { await this.refresh(); return super.createQualityRule(input); }
  ...
  async listDataSources() { await this.refresh(); return super.listDataSources(); }
